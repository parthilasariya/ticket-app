...
<!-- This file has been modified to replace the header with sidebar -->
<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.item icon="folder" href="https://www.rogers.com/" target="_blank">
                    {{ __('Rogers') }}
                </flux:navlist.item>
...
---------------------------------------------------------
<!-- It's a Header format file -->
<!-- This file has been modified to replace the sidebar with a top header navigation for better usability on smaller screens. -->
...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        <!-- Top Header Navigation replacing Sidebar -->
